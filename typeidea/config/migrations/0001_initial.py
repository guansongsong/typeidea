# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-04-17 09:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_type', models.PositiveIntegerField(choices=[('DISPLAY_HTML ', 'HTML'), ('DISPLAY_LATEST', '最新文章'), ('DISPLAY_HOT', '最热文章'), ('DISPLAY_COMMENT', '最近评论')], default=1, verbose_name='展示类型')),
